        ...
        <div className={`chapter-detail-container ${isSidebarOpen ? 'sidebar-open' : ''}`}>
            ...
            <div className="chapter-detail-header" style={{
                ...
                <button className="back-button" onClick={onBack} style={{
                    ...
                    <ArrowLeft size={24} color="var(--botanical-text-muted)" />
                </button>
                <div style={{ flex: 1, display: 'flex', alignItems: 'center' }}>
                    ...
                    <span style={{
                        ...
                        fontSize: '12px',
                        fontWeight: 600,
                        backgroundColor: mode === 'reader' ? 'rgba(74, 103, 65, 0.1)' : 'rgba(217, 160, 126, 0.1)',
                        color: mode === 'reader' ? 'var(--botanical-green-leaf)' : 'var(--botanical-accent-warm)',
                        whiteSpace: 'nowrap'
                    }}>
                    ...
                    <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                            ...
                            style={{
                                ...
                                gap: '8px',
                                padding: '8px 16px',
                                backgroundColor: (chapterStatus === 'PROCESSING' || chapterStatus === 'PENDING' || isAnalyzing) ? '#F3F4F6' : 'transparent',
                                color: (chapterStatus === 'PROCESSING' || chapterStatus === 'PENDING' || isAnalyzing) ? '#9CA3AF' : 'var(--botanical-brown-rich)',
                                border: (chapterStatus === 'PROCESSING' || chapterStatus === 'PENDING' || isAnalyzing) ? '1px solid #E5E7EB' : '1px solid var(--botanical-brown-rich)',
                                borderRadius: '6px',
                        ...
                        <button
                            ...
                            style={{
                                ...
                                gap: '8px',
                                padding: '8px 16px',
                                backgroundColor: 'var(--botanical-brown-rich)',
                                color: 'white',
                                border: 'none',
                                borderRadius: '6px',
                                                ...
                                                {character.traits && character.traits.length > 0
                                                    ? (
                                                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '4px', marginTop: '4px' }}>
                                                            {character.traits.slice(0, 3).map((trait, i) => <span key={i} style={{
                                                                fontSize: '10px',
                                                                padding: '2px 6px',
