...
class StoryConsistencyAgent:
    ...
    async def check_consistency(self, novel_id: int, input_text: str, current_chapter_id: Optional[int] = None, model: Optional[str] = None):
        # 1. Pinecone 벡터 검색
...
"""
        ...
        print(f"DEBUG: Using model {target_model} for consistency check")
