import { MessageCircle, MoreVertical, Settings, ShieldAlert, X, Sparkles } from 'lucide-react'; // Sparkles 아이콘 추가
...
interface FloatingMenuProps {
    ...
    onPredictStory?: () => void; // 스토리 예측 기능을 실행할 콜백 함수 추가
}

export function FloatingMenu({ onNavigateToScene, onCheckConsistency, onPredictStory }: FloatingMenuProps) {
