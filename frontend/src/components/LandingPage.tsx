...
const TOP_FEATURES = [
    {
        icon: <BookOpen size={29} strokeWidth={1.5} />,
        title: '자동 설정집',
        desc: '당신의 소설 속 인물과 장소, 사건 등을 빠르게 읽고 찾을 수 있도록 정리해줍니다.',
        tags: ['#해당_장면까지', '#자동_스크롤'],
    },
    {
        icon: <ShieldAlert size={29} strokeWidth={1.5} />,
        title: '설정 파괴 탐지기',
...
const BOTTOM_FEATURES = [
    {
        icon: <FileQuestion size={29} strokeWidth={1.5} />,
        title: '스토리 Q&A',
        tags: ['#소설_내용_검색', '#뭐든지_질문'],
    },
    {
        icon: <GitFork size={29} strokeWidth={1.5} className="rotate-90" />, // 아이콘 회전
        title: '스토리 예측',
        tags: ['#What-if', '#시뮬레이션'],
    },
    {
        icon: <MessageSquareMore size={29} strokeWidth={1.5} />,
        title: '캐릭터 챗봇',
        tags: ['#소설_인물과_직접', '#인터뷰'],
    },
];
