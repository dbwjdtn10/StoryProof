...
export default function App() {
  ...
  // 스플래시 이미지 존재 여부 확인 (로컬 에셋이므로 즉시 설정)
  useEffect(() => {
    setAvailableImages(SPLASH_IMAGE_URLS);
  }, []);
        ...
        <div className="login-card">
          ...
          <div className="brand-header">
            <div className="logo-icon">
              <img src={logoImg} alt="StoryProof Logo" />
            </div>
                ...
                <div style={{ display: 'flex', gap: '12px' }}>
                  <button
                    ...
                    style={{
                      ...
                      padding: '10px',
                      borderRadius: '8px',
                      border: `1px solid ${signupMode === 'writer' ? 'var(--primary)' : 'var(--border)'}`,
                      backgroundColor: signupMode === 'writer' ? 'var(--secondary)' : 'var(--card)',
                      color: signupMode === 'writer' ? 'var(--primary)' : 'var(--muted-foreground)',
                      cursor: 'pointer',
                      fontWeight: 500
                    }}
                  >
                  ...
                  <button
                    ...
                    style={{
                      ...
                      padding: '10px',
                      borderRadius: '8px',
                      border: `1px solid ${signupMode === 'reader' ? 'var(--accent)' : 'var(--border)'}`,
                      backgroundColor: signupMode === 'reader' ? 'var(--muted)' : 'var(--card)',
                      color: signupMode === 'reader' ? 'var(--accent)' : 'var(--muted-foreground)',
                      cursor: 'pointer',
                      fontWeight: 500
                    }}
                  >
