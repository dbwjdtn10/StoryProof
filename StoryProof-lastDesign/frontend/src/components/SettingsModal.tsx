...
import { X, User, Mail, LogOut, Cpu, Check, ChevronDown, ChevronUp, Trash2 } from 'lucide-react';
        ...
        >
            <div className="w-full flex flex-col h-full">
                ...
                <div className="p-6 space-y-6 overflow-y-auto custom-scrollbar">
                    ...
                    {/* LLM Model Section - Dropdown Style */}
                    <section>
                        <div className="flex items-center justify-between mb-2">
                            <h3 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">LLM AI 모델 선택</h3>
                        </div>
                        <div className="relative" ref={dropdownRef}>
                            ...
                            >
                                ...
                                {isModelDropdownOpen ? <ChevronUp size={16} className="text-gray-500" /> : <ChevronDown size={16} className="text-gray-500" />}
                            </button>
